...
namespace AppPrecioCanasta
{
    class ClassGlobal
    {
        ...
        public static List<Meses> Meses = new List<Meses>()
        {
            ...
            //datos del año 2008
            new Meses(37,"Enero",decimal.Parse("1844.10"),decimal.Parse("915.9"),decimal.Parse("132.8"),decimal.Parse("2863.70"),4),
            new Meses(38,"Febrero",decimal.Parse("1428.80"),decimal.Parse("813"),decimal.Parse("153.8"),decimal.Parse("2465.60"),4),
            new Meses(39,"Marzo",decimal.Parse("1734.50"),decimal.Parse("911.3"),decimal.Parse("174.3"),decimal.Parse("2178.20"),4),
            new Meses(40,"Abril",decimal.Parse("2156.30"),decimal.Parse("1203.90"),decimal.Parse("196.2"),decimal.Parse("2906.40"),4),
            new Meses(41,"Mayo",decimal.Parse("43012.60"),decimal.Parse("907.1"),decimal.Parse("186.6"),decimal.Parse("2606.30"),4),
            new Meses(42,"Junio",decimal.Parse("1180.00"),decimal.Parse("985.4"),decimal.Parse("137.1"),decimal.Parse("2689.50"),4),
            new Meses(43,"Julio",decimal.Parse("3051.10"),decimal.Parse("936.8"),decimal.Parse("177.9"),decimal.Parse("2790.80"),4),
            new Meses(44,"Agosto",decimal.Parse("1688.20"),decimal.Parse("846"),decimal.Parse("142.2"),decimal.Parse("2999.40"),4),
            new Meses(45,"Septiembre",decimal.Parse("2358.70"),decimal.Parse("902"),decimal.Parse("198.7"),decimal.Parse("2789.30"),4),
            new Meses(46,"Octubre",decimal.Parse("2031.20"),decimal.Parse("968.2"),decimal.Parse("159.2"),decimal.Parse("2849.60"),4),
            new Meses(47,"Noviembre",decimal.Parse("1480.80"),decimal.Parse("948.1"),decimal.Parse("179.3"),decimal.Parse("2998.20"),4),
            new Meses(48,"Diciembre",decimal.Parse("3079.30"),decimal.Parse("852.1"),decimal.Parse("181.4"),decimal.Parse("2774.80"),4),
        };
